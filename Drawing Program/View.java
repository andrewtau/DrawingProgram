...
class View extends JFrame {
  ...
  private JButton triangleButton; // New Triangle Button
  private JButton moveButton; // New Move Button
  ...
  public View() {
	...
	moveButton = new MoveButton(undoManager, this, drawingPanel); // New Move Button
	...
	buttonPanel.add(triangleButton); // New Triangle Button
	buttonPanel.add(moveButton); // New Move Button
